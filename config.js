...
module.exports = {
    ...
    FOOTER: process.env.FOOTER === undefined ? '𝙿𝙾𝚆𝙴𝚁𝙴𝙳 𝙱𝚈 LuciFER ²⁰²²' : process.env.FOOTER,
    ...
    CAP_BIO: process.env.CAP_BIO === undefined ? '© 𝙶𝙴𝙽𝙴𝚁𝙰𝚃𝙴𝙳 𝙱𝚈 LuciFER ²⁰²²' : process.env.CAP_BIO,
    CAPTION: process.env.CAPTION === undefined ? '© 𝙶𝙴𝙽𝙴𝚁𝙰𝚃𝙴𝙳 𝙱𝚈 LuciFER ²⁰²²' : process.env.CAPTION,
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://i.imgur.com/qzVgG1A.jpeg' : process.env.GAN_IMAGE,
    LANG: process.env.LANGUAGE === undefined ? 'EN' : process.env.LANGUAGE.toUpperCase(),
    INBOX_BLOCK: process.env.INBOX_BLOCK === undefined ? 'false' : process.env.INBOX_BLOCK,
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? 'ABBAYY ZINDAAA HOON' : process.env.ALIVE_MESSAGE,
    ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'https://i.imgur.com/qzVgG1A.jpeg' : process.env.ALIVE_LOGO,
    ...
    DEPLOYER: process.env.DEPLOYER === undefined ? 'LuciFER puPil' : process.env.DEPLOYER,
    ...
    BOT_NAME: process.env.BOT_NAME === undefined ? 'LuciFER' : process.env.BOT_NAME,
    ...
    LOGOPK_IMG: process.env.LOGOPK_IMG === undefined ? 'https://i.imgur.com/qzVgG1A.jpeg' : process.env.LOGOPK_IMG,
    ...
    SUPPORT: "923142478085-923082990885",
    SUPPORT2: "923142478085-923082990885",
    SUPPORT3: "923142478085-923082990885",
    Support4: "923142478085-923082990885",
    AMDI_1: "923142478085-923082990885",
    AMDI_2: "923142478085-923082990885",
    AMDI_3: "923142478085-923082990885",
    AMDI_4: "923142478085-923082990885",
    AMDI_5: "923142478085-923082990885",
    AMDI_6: "923142478085-923082990885",
    AMDI_7: "923142478085-923082990885",
    OWN: "923082990885,0"
};
